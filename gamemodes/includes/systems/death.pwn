...
stock ER_GetHospitalTreatmentTime(playerid, hospitalid, deliveredByEMS)
{
    ...
    // Always use ServerCore VIP hospital timers. Do not fall back to hardcoded 60 seconds.
    // VipHospitalTime0 applies to non-VIP/wanted players unless their VIP level is higher.
