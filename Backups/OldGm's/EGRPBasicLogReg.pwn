...
stock ConnectDatabase()
{
    ...
    mysql_tquery(g_SQL,
        ...
        cash INT DEFAULT START_CASH,\
        bank INT DEFAULT START_BANK,\
    ...
    switch(dialogid)
    {
        ...
        case DIALOG_BIRTHDATE:
        {
            ...
            mysql_format(g_SQL, query, sizeof(query),
                ...
                (username,password,gender,birthdate,skin,cash,bank,pos_x,pos_y,pos_z,pos_a,vw,interior) \
                VALUES ('%e','%e',%d,'%e',%d,%d,%d,%f,%f,%f,%f,%d,%d)",
                PlayerInfo[playerid][pName],
