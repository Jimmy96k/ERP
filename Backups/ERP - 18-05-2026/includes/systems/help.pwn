...
CMD:familyhelp(playerid, params[])
{
    ...
    SendClientMessage(playerid, COLOR_HELP, "/safedeposit /safewithdraw /gunlocker /motd /leavefamily /familysettings /capture /captureturf");
    return 1;
}
...
CMD:factionhelp(playerid, params[])
{
    ...
    SendClientMessage(playerid, COLOR_HELP, "/safedeposit /safewithdraw /gunlocker /motd /leavefaction /factionsettings /capture /captureturf /locker /cades /cones /spikes");
    return 1;
}
