...
stock ER_LocalChat(playerid, const text[], Float:range)
{
    ...
    if(PlayerInfo[playerid][pAccent] > 0) format(msg, sizeof(msg), "%s says [%s accent]: %s", ER_GetName(playerid), AccentNames[PlayerInfo[playerid][pAccent]], text);
    else format(msg, sizeof(msg), "%s says: %s", ER_GetName(playerid), text);
...
CMD:s(playerid, params[])
{
    ...
    new msg[160], Float:x, Float:y, Float:z;
    GetPlayerPos(playerid, x, y, z);
    format(msg, sizeof(msg), "%s shouts: %s!", ER_GetName(playerid), params);
...
CMD:newb(playerid, params[])
{
    ...
    new msg[160]; format(msg, sizeof(msg), "(( Newbie %s: %s ))", ER_GetName(playerid), params);
...
CMD:me(playerid, params[])
{
    ...
    new msg[160], Float:x, Float:y, Float:z;
    GetPlayerPos(playerid, x, y, z);
    format(msg, sizeof(msg), "* %s %s", ER_GetName(playerid), params);
...
CMD:do(playerid, params[])
{
    ...
    new msg[160], Float:x, Float:y, Float:z;
    GetPlayerPos(playerid, x, y, z);
    format(msg, sizeof(msg), "* %s (( %s ))", params, ER_GetName(playerid));
