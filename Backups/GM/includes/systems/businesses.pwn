...
stock ER_PlayerCanManageBusiness(playerid, bidx)
{
    ...
    switch(Businesses[bidx][bOwnerType])
    {
        ...
        case BUSINESS_OWNER_FAMILY: return PlayerInfo[playerid][pFamily] == Businesses[bidx][bOwnerID] && PlayerInfo[playerid][pFamilyRank] >= 5;
        case BUSINESS_OWNER_FACTION: return PlayerInfo[playerid][pFaction] == Businesses[bidx][bOwnerID] && PlayerInfo[playerid][pFactionRank] >= 5;
    }
    return 0;
}
...
stock ER_BusinessDialog(playerid, dialogid, response, listitem, const inputtext[])
{
    ...
    if(dialogid == DIALOG_MY_BUSINESS_MENU)
    {
        ...
        switch(listitem)
        {
            ...
            case 7:
            {
                return ER_Send(playerid, COLOR_GREY, "Business selling from owner menu is reserved for next code pass.");
            }
        }
        return 1;
    }
