...
CMD:factionhelp(playerid, params[])
{
    ...
    SendClientMessage(playerid, COLOR_HELP, "General: /factions /members /motd /department(/dept) /division(/div) /badge /locker /leavefaction /factionsettings");
    SendClientMessage(playerid, COLOR_HELP, "Management: /facinvite /fackick /divinvite /setdivision(/setdiv) /editfaction rank/division/member editor");
    SendClientMessage(playerid, COLOR_HELP, "Law: /su /wanted /cuff /uncuff /ticket /vticket /arrest /drag /undrag /detain /tazer /tackle /search(/frisk) /take /mdc(/vmdc)");
    SendClientMessage(playerid, COLOR_HELP, "Law Vehicles: /vcheck(/vlookup) /vradar(/radargun) /wheelclamp /clearcargo /takecarweapons /siren");
    SendClientMessage(playerid, COLOR_HELP, "EMS: /service ems /accept ems /heal(/aid) /revive(/renderaid) /drag /undrag /loadpt /deliverpt(/deliverpatient) /triage /emslist /healnear");
    SendClientMessage(playerid, COLOR_HELP, "News/Gov: /news /live /broadcast /sanhelp /gov /checktax /settax /taxdeposit /taxwithdraw");
    SendClientMessage(playerid, COLOR_HELP, "Deployables: /backup(/bk) /nobackup /backupint /cades /barrels /cones /spikes /flares /signs /ladders /tapes /destroy");
    SendClientMessage(playerid, COLOR_HELP, "Shared: /safedeposit /safewithdraw /capture /captureturf /ftrackveh(/ftrackcar) /ranks /clothes");
    return 1;
}
