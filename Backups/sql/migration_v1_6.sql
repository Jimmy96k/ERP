-- ERP v1.6 migration: login/tutorial spawn + vehicle command defaults
...
-- Optional: reset unfinished/new test accounts to NGRP spawn.
-- UPDATE `accounts` SET `spawn_x`=1715.0687,`spawn_y`=-1899.5597,`spawn_z`=13.5665,`spawn_a`=0.0,`spawn_int`=0,`spawn_vw`=0 WHERE `tutorial`=0;
