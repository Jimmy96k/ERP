...
stock ER_ShowVehicleComponentList(playerid, slot)
{
    ...
    switch(slot)
    {
        ...
        case 1:
        {
            ...
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Hood", 1026);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Hood", 1027);
        }
        case 2:
        {
        ...
        case 3, 4:
        {
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right Side Skirt", 1017);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left Side Skirt", 1026);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right Alien Side Skirt", 1030);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left X-Flow Side Skirt", 1031);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left Alien Side Skirt", 1036);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right X-Flow Side Skirt", 1039);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right Alien Side Skirt", 1040);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left X-Flow Side Skirt", 1041);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right X-Flow Side Skirt", 1051);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left Alien Side Skirt", 1052);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left Alien Side Skirt", 1069);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right Alien Side Skirt", 1070);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left X-Flow Side Skirt", 1071);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right X-Flow Side Skirt", 1072);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left Chrome Side Skirt", 1099);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right Chrome Strip", 1101);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left Chrome Strip", 1102);
        }
        case 5:
        {
        ...
        case 7:
        {
            ...
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Exhaust", 1126);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Exhaust", 1127);
        ...
        case 8:
        {
            ER_AddModRow(playerid, count, list, sizeof(list), "Offroad Wheels", 1025);
            ER_AddModRow(playerid, count, list, sizeof(list), "Shadow Rims", 1073);
            ER_AddModRow(playerid, count, list, sizeof(list), "Mega Rims", 1074);
            ER_AddModRow(playerid, count, list, sizeof(list), "Rimshine Rims", 1075);
            ER_AddModRow(playerid, count, list, sizeof(list), "Wires Rims", 1076);
            ER_AddModRow(playerid, count, list, sizeof(list), "Classic Rims", 1077);
            ER_AddModRow(playerid, count, list, sizeof(list), "Twist Rims", 1078);
            ER_AddModRow(playerid, count, list, sizeof(list), "Cutter Rims", 1079);
            ER_AddModRow(playerid, count, list, sizeof(list), "Switch Rims", 1080);
            ER_AddModRow(playerid, count, list, sizeof(list), "Grove Rims", 1081);
            ER_AddModRow(playerid, count, list, sizeof(list), "Import Rims", 1082);
            ER_AddModRow(playerid, count, list, sizeof(list), "Dollar Rims", 1083);
            ER_AddModRow(playerid, count, list, sizeof(list), "Trance Rims", 1084);
            ER_AddModRow(playerid, count, list, sizeof(list), "Atomic Rims", 1085);
            ER_AddModRow(playerid, count, list, sizeof(list), "Ahab Rims", 1096);
            ER_AddModRow(playerid, count, list, sizeof(list), "Virtual Rims", 1097);
            ER_AddModRow(playerid, count, list, sizeof(list), "Access Rims", 1098);
        }
        case 11:
        {
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Front Bumper", 1115);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Front Bumper", 1116);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Front Bumper", 1117);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Front Bumper", 1152);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Front Bumper", 1153);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Front Bumper", 1155);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Front Bumper", 1157);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Front Bumper", 1160);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Front Bumper", 1165);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Front Bumper", 1166);
            ...
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Front Bumper", 1173);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Front Bumper", 1174);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Front Bumper", 1175);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Front Bumper", 1179);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Front Bumper", 1181);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Front Bumper", 1182);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Front Bumper", 1185);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Front Bumper", 1188);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Front Bumper", 1189);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Front Bumper", 1190);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Front Bumper", 1191);
        }
        case 12:
        {
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Rear Bumper", 1109);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Rear Bumper", 1110);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Rear Bumper", 1140);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Rear Bumper", 1141);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Rear Bumper", 1148);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Rear Bumper", 1149);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Rear Bumper", 1150);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Rear Bumper", 1151);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Rear Bumper", 1154);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Rear Bumper", 1156);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Rear Bumper", 1159);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Rear Bumper", 1161);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "X-Flow Rear Bumper", 1167);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Alien Rear Bumper", 1168);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Rear Bumper", 1176);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Rear Bumper", 1177);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Rear Bumper", 1178);
            ...
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Rear Bumper", 1184);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Rear Bumper", 1186);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Rear Bumper", 1187);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Chrome Rear Bumper", 1192);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Slamin Rear Bumper", 1193);
        }
        case 13, 14:
        {
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left Oval Vents", 1142);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right Oval Vents", 1143);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Left Square Vents", 1144);
            ER_TryAddModRow(playerid, count, list, sizeof(list), model, "Right Square Vents", 1145);
        }
    }
...
stock ER_VehicleDialog(playerid, dialogid, response, listitem, inputtext[])
{
	...
	if(dialogid == DIALOG_EDIT_VEH_MOD_SELECT)
	{
		...
		switch(GetPVarInt(playerid, "EditingVehicleModSlot"))
		{
			...
			case 3: VehicleInfo[idx][vModSideskirtL] = component;
			case 4: VehicleInfo[idx][vModSideskirtR] = component;
