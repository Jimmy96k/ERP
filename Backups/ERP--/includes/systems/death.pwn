...
{
    new what[24];
    if(sscanf(params, "s[24]", what)) return ER_Send(playerid, COLOR_GREY, "USAGE: /accept [death/ems/family/faction/crew/division/invitation/gun]");
    ...
    return ER_Send(playerid, COLOR_GREY, "USAGE: /accept [death/ems/family/faction/crew/division/invitation/gun]");
}
