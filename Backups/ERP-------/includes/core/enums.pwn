...
enum E_PLAYER_INFO
{
    ...
    pSpawnInt,
    pSpawnVW,
    pJobSkill[MAX_EXPRESS_JOB_TYPES],
...
enum E_SERVER_CORE
{
    ...
    Float:scDefaultVehicleFuelConsumption,
    scVehicleIdleFuelEnabled,
    Float:scVehicleIdleFuelGallonsPerTick
};
