...
CMD:stats(playerid, params[])
{
    ...
    format(line, sizeof(line), "(Rope: %d) - (Sprunk: %d) - (Cigars: %d) - (Hotwire Tools: %d) - (Spray Cans: %d) - (Seeds: %d)",
        PlayerInfo[playerid][pRope], PlayerInfo[playerid][pSprunk], PlayerInfo[playerid][pCigar], PlayerInfo[playerid][pHotwireKits], PlayerInfo[playerid][pSprayCans], PlayerInfo[playerid][pSeeds]);
    SendClientMessage(playerid, COLOR_WHITE, line);
    SendClientMessage(playerid, COLOR_ORANGE, "------------------------------------------------------------");
    return 1;
}
